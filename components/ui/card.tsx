...
function Card({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      data-slot="card"
      className={cn(
        'flex flex-col gap-5 rounded-[20px] border border-white/10 bg-card py-5 text-card-foreground shadow-[0_0.5px_0_rgba(255,255,255,0.12),0_18px_45px_rgba(0,0,0,0.20)]',
        className,
      )}
      {...props}
    />
